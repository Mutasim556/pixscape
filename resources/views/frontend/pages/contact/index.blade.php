                    ...
                    <div class="section-padding is-contact">
                        <div class="section_content-grid is-2 is-line">
                            ...
                            <div id="w-node-c18e94ab-be36-286a-7d9c-577e32c398af-f9585faf" class="section_info-wrap">
                                <p class="p-70">{{ $contact ? $contact->address : '' }}</p><a href="{{ $contact ? $contact->location : '' }}" target="_blank"
                        ...
                        <div class="section_content-grid is-2 is-line">
                            ...
                            <div id="w-node-_0a7b3e8b-406b-1056-6df7-099951c39d92-f9585faf" class="section_info-wrap"><a
                                    href="tel:{{ $contact ? $contact->phone : '' }}" class="p-70 is-link">{{ $contact ? $contact->phone : '' }}</a></div>
                        </div>
                    ...
                    <div class="section-padding is-100svh">
                        <div class="contact_wrap">
                            <div class="section_content-grid is-2 is-light">
                                ...
                                <div id="w-node-_3654cfca-0814-8b9a-74b1-5c540c9634b3-f9585faf" class="section_info-wrap">
                                    <div class="form w-form">
                                        <form id="wf-form-Contact-Form" name="wf-form-Contact-Form" data-name="Contact Form"
                                            method="get" class="contact_form" data-wf-page-id="6543a9053fac558af9585faf"
                                            data-wf-element-id="20d92dea-8144-b37a-6c0b-8771b866a6ce">
                                            <div class="horizontal_1-5em"><input class="contact_input w-input"
                                                    maxlength="256" name="First-Name" data-name="First Name"
                                                    placeholder="First Name" type="text" id="first-name"
                                                    required="" /><input class="contact_input w-input" maxlength="256"
                                                    name="Surname" data-name="Surname" placeholder="Surname" type="text"
                                                    id="surname" required="" /></div><input
                                                class="contact_input w-input" maxlength="256" name="Email"
                                                data-name="Email" placeholder="Email" type="email" id="email"
                                                required="" /><input class="contact_input w-input" maxlength="256"
                                                name="Phone" data-name="Phone" placeholder="Phone" type="tel"
                                                id="phone" /><select id="Enquiry-type" name="Enquiry-type"
                                                data-name="Enquiry type" required=""
                                            ...
                                            <textarea id="Message" name="Message" maxlength="5000" data-name="Message" placeholder="Type your message..."
                                                required="" class="contact_input is-text-area w-input"></textarea>

                                            <div class="button is-white" style="color: white;border-bottom:1px solid white"><input type="submit" data-wait="Please wait..."
                                                    class="contact_submit-button w-button" value="Send Enquiry" />
                                                <div class="button_label">Send Enquiry</div>
                                                <div class="button_arrow w-embed" style="color: white"><svg width="100%" style=""
