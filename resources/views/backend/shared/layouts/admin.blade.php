...
<head>
    ...
    <style>
        ...
        .custom-tooltip .tooltip-text {
            ...
            /* 👇 Increase width so long email fits */
            min-width: 300px;
            white-space: nowrap;
                    ...
                    <ul class="nav-menus">
                            ...
                            <div class="translate_wrapper">
                                ...
                                <div class="more_lang">
                                    ...
                                    @foreach ($languages as $language)
                                        <a class="lang {{ getLanguageSession() == $language->lang ? 'selected' : '' }}"
                                            href="{{ route('admin.changeLanguage', $language->lang) }}">
                        ...
                        <li class="profile-nav onhover-dropdown">
                            ...
                            <ul class="profile-dropdown onhover-show-div">
                                <li><a href="{{ route('admin.profile') }}"><i data-feather="user"></i><span>
                                            {{ __('admin_local.Account') }}</span></a>
                                </li>
                                <li><a href="email_inbox.html"><i data-feather="mail"></i><span>
                                            {{ __('admin_local.Inbox') }}</span></a></li>
                                <li><a href="edit-profile.html"><i data-feather="settings"></i><span>
                                            {{ __('admin_local.Settings') }}</span></a></li>
                                <li><a href="{{ route('admin.logout') }}"><i data-feather="log-in"> </i><span>
                                            {{ __('admin_local.LogOut') }}</span></a></li>
                            </ul>
                        </li>
                    </ul>
                </div>
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-6 p-0 footer-left">
                            <p class="mb-0">Copyright © {{ date('Y') }} Pixscape. All rights reserved. </p>
                        </div>
