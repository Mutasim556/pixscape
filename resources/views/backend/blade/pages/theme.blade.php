        ...
        <div class="row">
            ...
            <div class="col-lg-10 mx-auto">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.settings.themeUpdate',1) }}" method="POST">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                <div class="col-md-3">
                                    <label for="">{{ __('admin_local.Theme Color') }}</label>
                                </div>
                                <div class="col-md-5">
                                    <input type="text" class="form-control" name="theme_color" id="theme_color" value="{{ $theme->theme_color }}">
                                </div>
                                <div class="col-md-2" style="background:{{ $theme->theme_color }};">
