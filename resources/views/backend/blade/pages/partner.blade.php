 ...
 @section('content')
     ...
     <div class="modal fade" id="add-partner-modal" tabindex="-1" aria-labelledby="bs-example-modal-lg" aria-hidden="true">
         <div class="modal-dialog modal-lg">
             <div class="modal-content">
                 ...
                 <div class="modal-body" style="margin-top: -20px">
                     <form method="POSt" action="" id="add_partner_form" enctype="multipart/form-data">
                         @csrf
                         <div class="row">
                                 ...
                                 <div class="tab-content mt-3" id="pills-successtabContent">
                                     <div class="tab-pane fade show active" id="pills-defaultLang" role="tabpanel"
                                         ...
                                         <div class="form-group">
                                             <label for="">{{ __('admin_local.Partner Name') }} (
                                         ...
                                         <div class="form-group">
                                             <label for="">{{ __('admin_local.Partner Details') }} (
                                                 {{ __('admin_local.Default') }} ) *</label>
                                             <textarea class="form-control ckeditorappend" name="partner_details" id="partner_details"></textarea>
                                             <span class="text-danger err-mgs" id="partner_details_err"></span>
                                         </div>
                                     </div>
                                     <script>
                                         var langCode = [];
                                         ...
                                         <div class="tab-pane fade" id="pills-{{ $lang->name }}" role="tabpanel"
                                             ...
                                             <div class="form-group">
                                                 ...
                                                 <input type="text" class="form-control"
                                                     name="partner_name_{{ $lang->lang }}"
                                                     id="partner_name_{{ $lang->lang }}">
                                             </div>

                                             <div class="form-group">
                                                 <label for="">{{ __('admin_local.partner Details') }} (
                                                     {{ $lang->name }} ) </label>
                                                 <textarea class="form-control" name="partner_details_{{ $lang->lang }}" id="partner_details_{{ $lang->lang }}"></textarea>
                                             </div>
                                         </div>
                                     @endforeach
                                 </div>
                             ...
                             <div class="col-sm-12 col-xl-6">
                                 <div class="row">
                                     <div class="form-group col-md-12">
                                         <label for="">{{ __('admin_local.partner Image') }} (180X150)
                                             *</label>
                                         <input type="file" class="form-control" name="partner_image" id="partner_image"
                                             accept="image/*"
                                             onchange="document.getElementById('prev_partner_image').src = window.URL.createObjectURL(this.files[0])">
                             ...
                             <div class="col-sm-12 col-xl-6">
                                 <div class="row">
                                     <div class="form-group col-md-12 text-end">
                                         <label for="">{{ __('admin_local.Preview Partner Image') }} *</label><br>
                                         <img src="" id="prev_partner_image" alt="" width="180"
                                             height="150">
                                     </div>
                                 </div>
                             </div>
     ...
     <div class="modal fade" id="edit-partner-modal" tabindex="-1" aria-labelledby="bs-example-modal-lg"
         aria-hidden="true">
         <div class="modal-dialog modal-lg">
             <div class="modal-content">
                 <div class="modal-header d-flex align-items-center" style="border-bottom:1px dashed gray">
                 ...
                 <div class="modal-body" style="margin-top: -20px">
                     <form id="edit_partner_form" enctype="multipart/form-data">
                         @csrf
                         @method('PUT')
                                 ...
                                 <div class="tab-content mt-3" id="epills-successtabContent">
                                     <div class="tab-pane fade show active" id="epills-defaultLang" role="tabpanel"
                                         ...
                                         <div class="form-group">
                                             <label for="">{{ __('admin_local.Partner Details') }} (
                                                 {{ __('admin_local.Default') }} ) *</label>
                                             <textarea class="form-control ckeditorappend" name="partner_details" id="partner_details2"></textarea>
                                             <span class="text-danger err-mgs" id="partner_details_err"></span>
                                         </div>
                                     </div>
                                     <script>
                                     ...
                                     @foreach (getLangs() as $lang)
                                         ...
                                         <div class="tab-pane fade" id="epills-{{ $lang->name }}" role="tabpanel"
                                             ...
                                             <div class="form-group">
                                                 <label for="">{{ __('admin_local.Partner Details') }} (
                                                     {{ $lang->name }} ) </label>
                                                 <textarea class="form-control" name="partner_details_{{ $lang->lang }}"
                                                     id="partner_details2_{{ $lang->lang }}"></textarea>
                                             </div>
                                         </div>
                                     @endforeach
                                 </div>
                         ...
                         <div class="row">
                                 ...
                                 <div class="row">
                                     <div class="form-group col-md-12">
                                         ...
                                         <input type="file" class="form-control" name="partner_image"
                                             id="partner_image" accept="image/*"
                                             onchange="document.getElementById('eprev_partner_image').src = window.URL.createObjectURL(this.files[0])">
                                         <span class="text-danger err-mgs" id="partner_image_err"></span>
                                     </div>
                             ...
                             <div class="col-sm-12 col-xl-6">
                                 <div class="row">
                                     <div class="form-group col-md-12 text-end">
                                         <label for="">{{ __('admin_local.Preview Partner Image') }} *</label><br>
                                         <img src="" id="eprev_partner_image" alt="" width="180"
                                             height="150">
                                     </div>
                                 </div>
                             </div>
             ...
             <div class="col-lg-12 mx-auto">
                 <div class="card">
                     <div class="card-header py-3" style="border-bottom: 2px dashed gray">
                         <h3 class="card-title mb-0 text-center">{{ __('admin_local.partners') }}</h3>
                     </div>
                             ...
                             <div class="row mb-3">
                                 <div class="col-md-3">
                                     <button class="btn btn-success" type="btn" data-bs-toggle="modal"
                                         data-bs-target="#add-partner-modal">+
                                         {{ __('admin_local.Add Partner') }}</button>
                                 </div>
                             </div>
                         @endif
                             ...
                             <table id="basic-1" class="display table-bordered">
                                 ...
                                 <tbody>
                                     @foreach ($partners as $partner)
                                         <tr id="trid-{{ $partner->id }}" data-id="{{ $partner->id }}">
                                             <td>
                                                 @if ($partner->partner_image)
                                                     <img height="50px" src="{{ asset($partner->partner_image) }}"
                                                         alt="">
                                                 @else
                                             ...
                                             <td>{!! $partner->partner_details !!}</td>
                                             <td class="text-center">
                                                 @if (hasPermission(['partner-update']))
                                                     <span
                                                         class="mx-2">{{ $partner->status == 0 ? 'Inactive' : 'Active' }}</span><input
                                                         data-status="{{ $partner->status == 0 ? 1 : 0 }}"
                                                         id="status_change" type="checkbox" data-toggle="switchery"
                                                         data-color="green" data-secondary-color="red" data-size="small"
                                                         {{ $partner->status == 1 ? 'checked' : '' }} />
                                                 @else
                                                     <span
                                                         ...
                                                         <div class="dropdown-content">
                                                             @if (hasPermission(['partner-update']))
                                                                 <a data-bs-toggle="modal" style="cursor: pointer;"
                                                                     data-bs-target="#edit-partner-modal"
 ...
 @push('js')
     ...
     @foreach (getLangs() as $lang)
         <script>
             CKEDITOR.replace('partner_details_' + '{{ $lang->lang }}', {
                 on: {
         ...
         <script>
             CKEDITOR.replace('partner_details2_' + '{{ $lang->lang }}', {
                 on: {
                     contentDom: function(evt) {
                         // Allow custom context menu only with table elemnts.
                         evt.editor.editable().on('contextmenu', function(contextEvent) {
     ...
     @endforeach
     <script>
         CKEDITOR.replace('partner_details', {
             on: {
                 contentDom: function(evt) {
                     // Allow custom context menu only with table elemnts.
                     evt.editor.editable().on('contextmenu', function(contextEvent) {
         ...
         CKEDITOR.replace('partner_details2', {
             on: {
                 contentDom: function(evt) {
                     // Allow custom context menu only with table elemnts.
                     evt.editor.editable().on('contextmenu', function(contextEvent) {
         ...
         var form_url = "{{ route('admin.pages.partner.store') }}";
     ...
     <script>
         var projPoint = `{{ __('admin_local.partner Points') }}`;
         var defa = `{{ __('admin_local.Default') }}`;
     </script>
     <script src="{{ asset(env('ASSET_DIRECTORY', 'public') . '/' . 'admin/custom/partner/partner.js') }}"></script>
