                     ...
                     <form method="POSt" action="" id="add_blog_form" enctype="multipart/form-data">
                         ...
                         <div class="row">
                             <div class="col-sm-12 col-xl-12">
                                 ...
                                 <div class="row">
                                     <div class="col-sm-12 col-xl-12">
                                         <label for="">{{ __('admin_local.Blog By') }}</label>
                                         <select name="team_member" id="team_member" class="js-example-basic-single">
                                            @php
                                                $teams = \App\Models\Admin\Team::where([['status',1],['delete',0]])->get();
                                            @endphp
                                            @foreach ($teams as $team)
                                            <option value="{{ $team->id }}">{{ $team->team_member_name }}</option>
                                            @endforeach
                                         </select>
                                     </div>
                                 </div>
                         ...
                         <div class="row">
                            <div class="col-sm-12 col-xl-6">
                             ...
                             <div class="col-sm-12 col-xl-6">
                                 <div class="row">
                                     <div class="form-group col-md-12">
                                         <label for="">{{ __('admin_local.Blog Images') }}
                                             *</label>
                         ...
                         <div class="row">
                             <div class="col-sm-12 col-xl-12">
                                 ...
                                 <div class="row">
                                     <div class="col-sm-12 col-xl-12">
                                         <label for="">{{ __('admin_local.Blog By') }}</label>
                                         <select name="team_member" id="team_member" class="js-example-basic-single2">
                                            @php
                                                $teams = \App\Models\Admin\Team::where([['status',1],['delete',0]])->get();
                                            @endphp
                                          ...
                                          <span class="text-danger err-mgs" id="team_member__err"></span>
                                     </div>
                                 </div>
                                     ...
                                     @foreach (getLangs() as $lang)
                                         ...
                                         <div class="tab-pane fade" id="epills-{{ $lang->name }}" role="tabpanel"
                                             ...
                                             <div class="form-group">
                                                 <label for="">{{ __('admin_local.Blog Details') }} (
                                                     {{ $lang->name }} ) </label>
                                                 <textarea class="form-control" name="blog_details_{{ $lang->lang }}" id="blog_details2_{{ $lang->lang }}"></textarea>
                                             </div>
                                         </div>
                                     @endforeach
                                 </div>
 ...
 @push('js')
     ...
     <script>
         ...
         $('.js-example-basic-single').select2({
             dropdownParent: $('#add-blog-modal')
         });
         $('.js-example-basic-single2').select2({
             dropdownParent: $('#edit-blog-modal')
         });
