 ...
 @section('content')
     ...
     <div class="modal fade" id="add-sub-service-modal" tabindex="-1" aria-labelledby="bs-example-modal-lg" aria-hidden="true">
         <div class="modal-dialog modal-lg">
             <div class="modal-content">
                 <div class="modal-header d-flex align-items-center" style="border-bottom:1px dashed gray">
                     <h4 class="modal-title" id="myLargeModalLabel">
                         {{ __('admin_local.Add Sub-Service') }}
                     </h4>
                 ...
                 <div class="modal-body" style="margin-top: -20px">
                     <form method="POSt" action="" id="add_sub_service_form" enctype="multipart/form-data">
                         @csrf
                         <div class="row">
                                 ...
                                 <div class="tab-content mt-3" id="pills-successtabContent">
                                     <div class="tab-pane fade show active" id="pills-defaultLang" role="tabpanel"
                                         ...
                                         <div class="form-group">
                                             <label for="">{{ __('admin_local.Sub-Service Name') }} (
                                                 {{ __('admin_local.Default') }} ) *</label>
                                             <input type="text" class="form-control" name="sub_service_name"
                                                 id="sub_service_name">
                                             <span class="text-danger err-mgs" id="sub_service_name_err"></span>
                                         </div>

                                         <div class="form-group">
                                             <label for="">{{ __('admin_local.Short Details') }} (
                                                 {{ __('admin_local.Default') }} ) *</label>
                                             <input type="text" class="form-control" name="sub_service_short_details"
                                                 id="sub_service_short_details">
                                             <span class="text-danger err-mgs" id="sub_service_short_details_err"></span>
                                         </div>

                                         <div class="form-group">
                                             <label for="">{{ __('admin_local.Sub-Service Details') }} (
                                                 {{ __('admin_local.Default') }} ) *</label>
                                             <textarea class="form-control ckeditorappend" name="sub_service_details" id="sub_service_details"></textarea>
                                             <span class="text-danger err-mgs" id="sub_service_details_err"></span>
                                         </div>
                                     </div>
                                     <script>
                                         var langCode = [];
                                         ...
                                         <div class="tab-pane fade" id="pills-{{ $lang->name }}" role="tabpanel"
                                             ...
                                             <div class="form-group">
                                                 ...
                                                 <input type="text" class="form-control"
                                                     name="sub_service_name_{{ $lang->lang }}"
                                                     id="sub_service_name_{{ $lang->lang }}">
                                             </div>
                                             <div class="form-group">
                                                 <label for="">{{ __('admin_local.Short Details') }} (
                                                     {{ $lang->name }} ) </label>
                                                 <input type="text" class="form-control"
                                                     name="sub_service_short_details_{{ $lang->lang }}"
                                                     id="sub_service_short_details_{{ $lang->lang }}">
                                             </div>
                                             <div class="form-group">
                                                 <label for="">{{ __('admin_local.Sub-Service Details') }} (
                                                     {{ $lang->name }} ) </label>
                                                 <textarea class="form-control" name="sub_service_details_{{ $lang->lang }}"
                                                     id="sub_service_details_{{ $lang->lang }}"></textarea>
                                             </div>
                                         </div>
                                     @endforeach
                                 </div>
                         ...
                         <div class="row">
                             ...
                             <div class="col-sm-12 col-xl-6">
                                 <div class="row">
                                     <div class="form-group col-md-12">
                                         <label for="">{{ __('admin_local.Sub-Service Image') }}</label>
                                         <input type="file" class="form-control" name="sub_service_image"
                                             id="sub_service_image"
                                             onchange="document.getElementById('prev_sub_service_image').src = window.URL.createObjectURL(this.files[0])">
                                         <span class="text-danger err-mgs" id="sub_service_image_err"></span>
                                     </div>
                                     <div class="form-group col-md-12">
                                         <label for="">{{ __('admin_local.Preview Sub-Service Image') }}
                                             *</label><br>
                                         <img src="" id="prev_sub_service_image" alt="" width="100%">
                                     </div>
                                 </div>
                             </div>
     ...
     <div class="modal fade" id="edit-sub-service-modal" tabindex="-1" aria-labelledby="bs-example-modal-lg"
         aria-hidden="true">
         <div class="modal-dialog modal-lg">
             <div class="modal-content">
                 <div class="modal-header d-flex align-items-center" style="border-bottom:1px dashed gray">
                     <h4 class="modal-title" id="myLargeModalLabel">
                         {{ __('admin_local.Edit Sub-Service') }}
                     </h4>
                     <button type="button" class="btn-close " data-bs-dismiss="modal" aria-label="Close"></button>
                 </div>
                 <p class="px-3 text-danger">
                 ...
                 <div class="modal-body" style="margin-top: -20px">
                     <form id="edit_sub_service_form" enctype="multipart/form-data">
                         @csrf
                         @method('PUT')
                             ...
                             <div class="col-sm-12 col-xl-12">
                                 ...
                                 <div class="tab-content mt-3" id="epills-successtabContent">
                                     <div class="tab-pane fade show active" id="epills-defaultLang" role="tabpanel"
                                         ...
                                         <div class="form-group">
                                             <label for="">{{ __('admin_local.Sub-Services Details') }} (
                                                 {{ __('admin_local.Default') }} ) *</label>
                                             <textarea class="form-control ckeditorappend" name="sub_service_details" id="sub_service_details2"></textarea>
                                             <span class="text-danger err-mgs" id="sub_service_details_err"></span>
                                         </div>
                                     </div>
                                     <script>
                                         ...
                                         <div class="tab-pane fade" id="epills-{{ $lang->name }}" role="tabpanel"
                                             ...
                                             <div class="form-group">
                                                 <label for="">{{ __('admin_local.Sub-Services Details') }} (
                                                     {{ $lang->name }} ) </label>
                                                 <textarea class="form-control" name="sub_service_details_{{ $lang->lang }}"
                                                     id="sub_service_details2_{{ $lang->lang }}"></textarea>
                                             </div>
                                         </div>
                                     @endforeach
                                 </div>
                             ...
                             <div class="col-sm-12 col-xl-6">
                                 <div class="row">
                                     <div class="form-group col-md-12">
                                         ...
                                         <input type="file" class="form-control" name="sub_service_image"
                                             id="sub_service_image"
                                             onchange="document.getElementById('eprev_sub_service_image').src = window.URL.createObjectURL(this.files[0])">
                                         <span class="text-danger err-mgs" id="sub_service_image_err"></span>
                                     </div>
                                     <div class="form-group col-md-12">
                                         <label for="">{{ __('admin_local.Preview Sub-Service Image') }}
                                             *</label><br>
                                         <img src="" id="eprev_sub_service_image" alt="" width="100%">
                                     </div>
                                 </div>
                             </div>
             ...
             <div class="col-lg-10 mx-auto">
                 <div class="card">
                     <div class="card-header py-3" style="border-bottom: 2px dashed gray">
                         <h3 class="card-title mb-0 text-center">{{ __('admin_local.Sub-Service') }}</h3>
                     </div>

                     <div class="card-body">
                         @if (hasPermission(['sub-service-store']))
                             <div class="row mb-3">
                                 <div class="col-md-3">
                                     <button class="btn btn-success" type="btn" data-bs-toggle="modal"
                                         data-bs-target="#add-sub-service-modal">+
                                         {{ __('admin_local.Add Sub-Service') }}</button>
                                 </div>
                             </div>
                         @endif
                             ...
                             <table id="basic-1" class="display table-bordered">
                                 ...
                                 <tbody>
                                     @foreach ($subservices as $subservice)
                                         <tr id="trid-{{ $subservice->id }}" data-id="{{ $subservice->id }}">
                                             <td>{{ $subservice->name }}</td>
                                             <td>{{ $subservice->short_details }}</td>
                                             <td>{!! \Illuminate\Support\Str::limit(strip_tags($subservice->details), 20) !!}</td>
                                             <td>{{ $subservice->type }}</td>

                                             <td class="text-center">
                                                 @if (hasPermission(['sub-service-update']))
                                                     <span
                                                         class="mx-2">{{ $subservice->status == 0 ? 'Inactive' : 'Active' }}</span><input
                                                         data-status="{{ $subservice->status == 0 ? 1 : 0 }}"
                                                         id="status_change" type="checkbox" data-toggle="switchery"
                                                         data-color="green" data-secondary-color="red" data-size="small"
                                                         {{ $subservice->status == 1 ? 'checked' : '' }} />
                                                 @else
                                                     <span
                                             ...
                                             <td>
                                                 @if (hasPermission(['sub-service-update', 'sub-service-delete']))
                                                     <div class="dropdown">
                                                         <button
 ...
 @push('js')
     ...
     @foreach (getLangs() as $lang)
         <script>
             CKEDITOR.replace('sub_service_details_' + '{{ $lang->lang }}', {
                 on: {
         ...
         <script>
             CKEDITOR.replace('sub_service_details2_' + '{{ $lang->lang }}', {
                 on: {
                     contentDom: function(evt) {
                         // Allow custom context menu only with table elemnts.
                         evt.editor.editable().on('contextmenu', function(contextEvent) {
     ...
     @endforeach
     <script>
         CKEDITOR.replace('sub_service_details', {
             on: {
                 contentDom: function(evt) {
                     // Allow custom context menu only with table elemnts.
                     evt.editor.editable().on('contextmenu', function(contextEvent) {
         ...
         CKEDITOR.replace('sub_service_details2', {
             on: {
                 contentDom: function(evt) {
                     // Allow custom context menu only with table elemnts.
                     evt.editor.editable().on('contextmenu', function(contextEvent) {
         ...
         var form_url = "{{ route('admin.pages.sub-service.store') }}";
     ...
     <script src="{{ asset(env('ASSET_DIRECTORY', 'public') . '/' . 'admin/custom/sub-service/sub-service.js') }}">
     </script>
