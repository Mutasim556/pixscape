 ...
 @section('content')
     ...
     <div class="modal fade" id="add-client-modal" tabindex="-1" aria-labelledby="bs-example-modal-lg" aria-hidden="true">
         <div class="modal-dialog modal-lg">
             <div class="modal-content">
                 <div class="modal-header d-flex align-items-center" style="border-bottom:1px dashed gray">
                     <h4 class="modal-title" id="myLargeModalLabel">
                         {{ __('admin_local.Add Client') }}
                     </h4>
                 ...
                 <div class="modal-body" style="margin-top: -20px">
                     <form method="POSt" action="" id="add_client_form" enctype="multipart/form-data">
                         @csrf
                         <div class="row">
                                 ...
                                 <div class="tab-content mt-3" id="pills-successtabContent">
                                     <div class="tab-pane fade show active" id="pills-defaultLang" role="tabpanel"
                                         ...
                                         <div class="form-group">
                                             <label for="">{{ __('admin_local.Client Name') }} (
                                                 {{ __('admin_local.Default') }} ) *</label>
                                             <input type="text" class="form-control" name="client_name"
                                                 id="client_name">
                                             <span class="text-danger err-mgs" id="client_name_err"></span>
                                         </div>


                                         <div class="form-group">
                                             <label for="">{{ __('admin_local.Client Details') }} (
                                                 {{ __('admin_local.Default') }} ) *</label>
                                             <textarea class="form-control ckeditorappend" name="client_details" id="client_details"></textarea>
                                             <span class="text-danger err-mgs" id="client_details_err"></span>
                                         </div>
                                     </div>
                                     <script>
                                         var langCode = [];
                                         ...
                                         <div class="tab-pane fade" id="pills-{{ $lang->name }}" role="tabpanel"
                                             ...
                                             <div class="form-group">
                                                 ...
                                                 <input type="text" class="form-control"
                                                     name="client_name_{{ $lang->lang }}"
                                                     id="client_name_{{ $lang->lang }}">
                                             </div>

                                             <div class="form-group">
                                                 <label for="">{{ __('admin_local.Client Details') }} (
                                                     {{ $lang->name }} ) </label>
                                                 <textarea class="form-control" name="client_details_{{ $lang->lang }}" id="client_details_{{ $lang->lang }}"></textarea>
                                             </div>
                                         </div>
                                     @endforeach
                                 </div>
                             ...
                             <div class="col-sm-12 col-xl-6">
                                 <div class="row">
                                     <div class="form-group col-md-12">
                                         <label for="">{{ __('admin_local.Client Image') }} (180X150)
                                             *</label>
                                         <input type="file" class="form-control" name="client_image" id="client_image"
                                             accept="image/*"
                                             onchange="document.getElementById('prev_client_image').src = window.URL.createObjectURL(this.files[0])">
                                         <span class="text-danger err-mgs" id="client_image_err"></span>
                                     </div>
                             ...
                             <div class="col-sm-12 col-xl-6">
                                 <div class="row">
                                     <div class="form-group col-md-12 text-end">
                                         <label for="">{{ __('admin_local.Preview Client Image') }} *</label><br>
                                         <img src="" id="prev_client_image" alt="" width="180"
                                             height="150">
                                     </div>
                                 </div>
                             </div>
     ...
     <div class="modal fade" id="edit-client-modal" tabindex="-1" aria-labelledby="bs-example-modal-lg"
         aria-hidden="true">
         <div class="modal-dialog modal-lg">
             <div class="modal-content">
                 <div class="modal-header d-flex align-items-center" style="border-bottom:1px dashed gray">
                     <h4 class="modal-title" id="myLargeModalLabel">
                         {{ __('admin_local.Edit Client') }}
                     </h4>
                     <button type="button" class="btn-close " data-bs-dismiss="modal" aria-label="Close"></button>
                 </div>
                 <p class="px-3 text-danger">
                                 ...
                                 <div class="tab-content mt-3" id="epills-successtabContent">
                                     <div class="tab-pane fade show active" id="epills-defaultLang" role="tabpanel"
                                         ...
                                         <div class="form-group">
                                             <label for="">{{ __('admin_local.Client Details') }} (
                                                 {{ __('admin_local.Default') }} ) *</label>
                                             <textarea class="form-control ckeditorappend" name="client_details" id="client_details2"></textarea>
                                             <span class="text-danger err-mgs" id="client_details_err"></span>
                                         </div>
                                     </div>
                                     <script>
                                     ...
                                     @foreach (getLangs() as $lang)
                                         ...
                                         <div class="tab-pane fade" id="epills-{{ $lang->name }}" role="tabpanel"
                                             ...
                                             <div class="form-group">
                                                 <label for="">{{ __('admin_local.Client Details') }} (
                                                     {{ $lang->name }} ) </label>
                                                 <textarea class="form-control" name="client_details_{{ $lang->lang }}"
                                                     id="client_details2_{{ $lang->lang }}"></textarea>
                                             </div>
                                         </div>
                                     @endforeach
                                 </div>
                         ...
                         <div class="row">
                                 ...
                                 <div class="row">
                                     <div class="form-group col-md-12">
                                         ...
                                         <input type="file" class="form-control" name="client_image"
                                             id="client_image" accept="image/*"
                                             onchange="document.getElementById('eprev_client_image').src = window.URL.createObjectURL(this.files[0])">
                                         <span class="text-danger err-mgs" id="client_image_err"></span>
                                     </div>
                             ...
                             <div class="col-sm-12 col-xl-6">
                                 <div class="row">
                                     <div class="form-group col-md-12 text-end">
                                         <label for="">{{ __('admin_local.Preview Client Image') }} *</label><br>
                                         <img src="" id="eprev_client_image" alt="" width="180"
                                             height="150">
                                     </div>
                                 </div>
                             </div>
             ...
             <div class="col-lg-12 mx-auto">
                 <div class="card">
                     <div class="card-header py-3" style="border-bottom: 2px dashed gray">
                         <h3 class="card-title mb-0 text-center">{{ __('admin_local.clients') }}</h3>
                     </div>

                     <div class="card-body">
                         @if (hasPermission(['client-store']))
                             <div class="row mb-3">
                                 <div class="col-md-3">
                                     <button class="btn btn-success" type="btn" data-bs-toggle="modal"
                                         data-bs-target="#add-client-modal">+
                                         {{ __('admin_local.Add Client') }}</button>
                                 </div>
                             </div>
                         @endif
                             ...
                             <table id="basic-1" class="display table-bordered">
                                 ...
                                 <tbody>
                                     @foreach ($clients as $client)
                                         <tr id="trid-{{ $client->id }}" data-id="{{ $client->id }}">
                                             <td>
                                                 @if ($client->client_image)
                                                     <img height="50px" src="{{ asset($client->client_image) }}"
                                                         alt="">
                                                 @else
                                             ...
                                             <td>{!! $client->client_details !!}</td>
                                             <td class="text-center">
                                                 @if (hasPermission(['client-update']))
                                                     <span
                                                         class="mx-2">{{ $client->status == 0 ? 'Inactive' : 'Active' }}</span><input
                                                         data-status="{{ $client->status == 0 ? 1 : 0 }}"
                                             ...
                                             <td>
                                                 @if (hasPermission(['client-update', 'client-delete']))
                                                     <div class="dropdown">
                                                         <button
 ...
 @push('js')
     ...
     @foreach (getLangs() as $lang)
         <script>
             CKEDITOR.replace('client_details_' + '{{ $lang->lang }}', {
                 on: {
         ...
         <script>
             CKEDITOR.replace('client_details2_' + '{{ $lang->lang }}', {
                 on: {
                     contentDom: function(evt) {
                         // Allow custom context menu only with table elemnts.
                         evt.editor.editable().on('contextmenu', function(contextEvent) {
     ...
     @endforeach
     <script>
         CKEDITOR.replace('client_details', {
             on: {
                 contentDom: function(evt) {
                     // Allow custom context menu only with table elemnts.
                     evt.editor.editable().on('contextmenu', function(contextEvent) {
         ...
         CKEDITOR.replace('client_details2', {
             on: {
                 contentDom: function(evt) {
                     // Allow custom context menu only with table elemnts.
                     evt.editor.editable().on('contextmenu', function(contextEvent) {
         ...
         var form_url = "{{ route('admin.pages.client.store') }}";
     ...
     <script>
         var projPoint = `{{ __('admin_local.client Points') }}`;
         var defa = `{{ __('admin_local.Default') }}`;
     </script>
     <script src="{{ asset(env('ASSET_DIRECTORY', 'public') . '/' . 'admin/custom/client/client.js') }}"></script>
